 ...
 */
public class OrbitzFlightObtainer implements MultiCityFlightObtainer
{
  private SimpleDateFormat m_dateFormatter = new SimpleDateFormat("dd.MM.yyyy");
  private static final Logger LOG = Logger.getLogger(OrbitzFlightObtainer.class);
      ...
      Date date1, String from2, String to2, Date date2, String from3, String to3, Date date3, Integer numOfPersons, boolean changeProxy) throws Exception
  {
    ...
    String hostAddress = "http://www.orbitz." + addressRoot;
  ...
  {
    MultiCityFlightObtainer obtainer = new OrbitzFlightObtainer();
    SimpleDateFormat formatter = new SimpleDateFormat("dd.MM.yyyy");
    try
    {
      obtainer.search(null, "com", "VCE", "BKK", formatter.parse("1.12.2013"), "BKK", "VCE", formatter.parse("31.01.2014"), "LJU", "NYC", formatter.parse("07.02.2014"), 1, false);
    }
    catch (Exception e)
    {
      e.printStackTrace();
